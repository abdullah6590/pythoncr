...
nav_template = """    <nav class="top-nav">
        <div class="dropdown">
            <button class="dropbtn__PY_ACTIVE__">🐍 Python <span class="caret">▼</span></button>
        ...
        <div class="dropdown">
            <button class="dropbtn__LI_ACTIVE__">📚 Libraries <span class="caret">▼</span></button>
            <div class="dropdown-content">
        ...
        <div class="dropdown">
            <button class="dropbtn__ML_ACTIVE__">🤖 Machine Learning <span class="caret">▼</span></button>
            <div class="dropdown-content">
        ...
        <div class="dropdown">
            <button class="dropbtn__DL_ACTIVE__">🧠 Deep Learning <span class="caret">▼</span></button>
            <div class="dropdown-content">
                <a href="dl-intro.html"__DLIN_ACTIVE__>🚀 Introduction</a>
            </div>
        </div>
        <div class="dropdown">
            <button class="dropbtn__MA_BTN_ACTIVE__">➗ Mathematics <span class="caret">▼</span></button>
            <div class="dropdown-content">
...
for f in files:
    ...
    # Strip out unused placeholders
    all_tokens = [
        '__PY_ACTIVE__', '__BA_ACTIVE__', '__FN_ACTIVE__', '__OO_ACTIVE__',
    ...
    for t in all_tokens:
        custom_nav = custom_nav.replace(t, '')
...
print(f"Fixed {len(files)} navbars.")
